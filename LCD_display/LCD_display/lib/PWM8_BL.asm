...
;  Global Symbols
;-----------------------------------------------
export  PWM8_BL_EnableInt
export _PWM8_BL_EnableInt
export  PWM8_BL_DisableInt
export _PWM8_BL_DisableInt
export  PWM8_BL_Start
export _PWM8_BL_Start
export  PWM8_BL_Stop
export _PWM8_BL_Stop
export  PWM8_BL_WritePeriod
export _PWM8_BL_WritePeriod
export  PWM8_BL_WritePulseWidth
export _PWM8_BL_WritePulseWidth
export  PWM8_BL_bReadPulseWidth
export _PWM8_BL_bReadPulseWidth
export  PWM8_BL_bReadCounter
export _PWM8_BL_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_BL_ReadPulseWidth    ; deprecated
export _bPWM8_BL_ReadPulseWidth    ; deprecated
export  bPWM8_BL_ReadCounter       ; deprecated
export _bPWM8_BL_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_BL_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_BL_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_BL_WritePeriod
;
;  DESCRIPTION:
...
;
 PWM8_BL_WritePeriod:
_PWM8_BL_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_BL_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_BL_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_BL_WritePulseWidth:
_PWM8_BL_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_BL_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_BL_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_BL_bReadPulseWidth:
_PWM8_BL_bReadPulseWidth:
 bPWM8_BL_ReadPulseWidth:                        ; this name deprecated
_bPWM8_BL_ReadPulseWidth:                        ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_BL_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_BL_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_BL_bReadCounter:
_PWM8_BL_bReadCounter:
 bPWM8_BL_ReadCounter:                           ; this name deprecated
_bPWM8_BL_ReadCounter:                           ; this name deprecated
   ...
   mov   A, reg[PWM8_BL_COMPARE_REG]             ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_BL_Stop_M                                ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_BL_INPUT_REG]               ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_BL_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_BL_COUNTER_REG]             ; DR2 <- DR0
   mov   A, reg[PWM8_BL_COMPARE_REG]             ; Stash the Count on the stack
   ...
   mov   reg[PWM8_BL_INPUT_REG], A               ;
   M8C_SetBank0                                  ;
   PWM8_BL_Start_M                               ;   then re-enable the PWM.
